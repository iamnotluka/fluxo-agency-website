		...
		<div className="bg-white text-black sm:py-20 md:py-24 py-10 pb-4 px-4">
			<div className="w-full max-w-3xl text-left sm:text-center pb-11 mx-auto">
				...
				<div className="text-left text-lg">
					...
					<br />
					<p>
						I challenge you: Try reaching out to 30,000 businesses with a well-crafted cold email. I bet you'll book at
						least 60 sales meetings. If not, I owe you a coffee and a ham and cheese toaste (I'm serious).
					</p>
					<br />
					<p>
						That's how fluxo came to life. We partner with driven and ambitious agencies with real results and help them
						overcome the hurdle we had to face ourselves.
					</p>
					<br />
					<p>
