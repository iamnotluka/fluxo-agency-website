			...
			<div className="bg-white text-black sm:py-10 md:py-10 py-5 pb-4 px-4">
				<div className="w-full max-w-3xl text-left sm:text-center pb-11 mx-auto">
					<div className="text-left bg-white">
						...
						<br></br>
						<p>
							From the tech trenches of Amazon to the cutting edge of digital marketing, my obsession has always been
							about one thing: optimisation.
						</p>
						<br />
						...
						<br />
						<p>
							It was an amazing time, yet something was missing. I wanted to blend the precision of data and algorithms
							with the nuances of human psychology.
						</p>
						<br />
						<p>That's when I discovered the magic of paid ads.</p>
						<br />
						<p>
							It was like alchemy - the mix of right elements: deploy, watch the data, tweak and behold a steady stream
							of leads and sales.
						</p>
						<br />
						<p>Sounds too good to be true? Unfortunatelly...</p>
						<br />
						...
						<br />
						<p>
							That buggy Meta Ads Platform screen refreshes and you see a little “Active” sign along your campaigns.
						</p>
						<br />
						...
						<p className="font-bold">
							Paid ads are gold, but only if your entire sales engine is firing on all cylinders. Otherwise, it's like
							pouring your budget into a black hole.
						</p>
						<br />
						<p>I realised the missing piece: consulting on sales and building robust sales systems.</p>
						<br />
						<p>
							But most often, by the time everything clicked, clients were out of the door, leaving a trail of missed
							opportunities and harsh reviews.
						</p>
						<br />
						<p>
							This realisation wasn't just about clients work. Scaling my own agency, I faced the same hurdles. Great
							leads were coming in, but reliance on ad spend was a constant thorn on my side.
						</p>
						<br />
						...
						<br />
						<p>
							I challenge you: Try reaching out to 30,000 businesses with a well-crafted cold email. I bet you'll book
							at least 60 sales meetings. If not, I owe you a coffee and a ham and cheese toaste (I'm serious).
						</p>
						<br />
						<p>
							That's how <strong>fluxo</strong> came to life. <br />
							<br></br>We partner with driven and ambitious agencies with real results and help them overcome the hurdle
							we had to face ourselves. From outreach, offers to sales, we are equiped to tackle any problem you throw
							at us. <br />
							<br />
							And yes, we still work strictly on a pey-per-result basis. Why? Because we can.
						</p>
						<br />
						<p>
							It's not just about overcoming the challenges we faced, it's about empowering you to do what you do the
